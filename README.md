...
AUTHORS - Name of the authors who wrote the simple shell.
README.md - Readme file that gives an overview of how to use the console.
console.py - A unit accommodating a set of controls for AirBnb clone.
In the models file:

__init__.py - file that connects File_storage, console, and Basemodel together.
amenity.py - class amenity that inherits from BaseModel
base_model.py - BaseModel framework that other classes inherit from.
